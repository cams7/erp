...
public class FreedomGMS extends AplicativoPD {
	...
	public FreedomGMS() {
		...
		super("icongms.png", "splashGMS.png", 1, "Freedom", 8, "Gestão de Materiais e Serviços", null,
		...
		addOpcao(100103000, TP_OPCAO_ITEM, "Kits de produtos", "Kits de produtos", 'K', 100103070, 3, true,
				FGrupoProd.class);
		...
		addSeparador(100104000);
		addOpcao(100104000, TP_OPCAO_ITEM, "Natureza de operação", "Naturezas", 'z', 100104040, 3, true,
				FNatoPer.class);
		addSeparador(100104000);
		...
		addOpcao(100105000, TP_OPCAO_ITEM, "Atribuições por usuário", "Atribuição por usuário", 'u', 100105020, 4, true,
				FAtribUsu.class);
		...
		addOpcao(100201000, TP_OPCAO_ITEM, "Modelo", "Modelo de etiquetas", 'M', 100201010, 3, true,
				FModEtiqueta.class);
		...
		addOpcao(100200000, TP_OPCAO_ITEM, "Imp. tabelas de fornecedores", "Imp. tabelas de fornecedores", 'I',
				100202000, 2, true, FImpTabFor.class);
		addSeparador(100200000);
		addOpcao(100200000, TP_OPCAO_ITEM, "Ajuste do item do orçamento", "Ajuste do item do orçamento", 'A', 100203000,
				2, true, FStatusItOrc.class);
		addSeparador(100200000);
		addOpcao(100200000, TP_OPCAO_ITEM, "Fornecedores homologados", "Fornecedores homologados", 'H', 100204000, 2,
				true, FHomologFor.class);
		...
		addOpcao(100304000, TP_OPCAO_ITEM, "Preferências Gerais", "Preferências Gerais", 'G', 100304010, 3, true,
				FPrefereGeral.class);
		addOpcao(100304000, TP_OPCAO_ITEM, "Preferências GMS", "Preferências GMS", 'S', 100304020, 3, true,
				FPrefereGMS.class);
		...
		addOpcao(200000000, TP_OPCAO_ITEM, "Solicitação de Compra", "Solicitação de Compra", 'S', 200100000, 1, true,
				FSolicitacaoCompra.class);
		addOpcao(200000000, TP_OPCAO_ITEM, "Pesquisa Solicitações de Compra", "Pesquisa Solicitações de Compra", 'P',
				200300000, 1, true, FConsSol.class);
		addOpcao(200000000, TP_OPCAO_ITEM, "Pesquisa Compra", "Pesquisa Compra", 'P', 200400000, 1, true,
				FConsCompra.class);
		...
		addSeparador(200000000);
		addOpcao(200000000, TP_OPCAO_ITEM, "Gestão de Solicitações de Compra", "Gestão de Solicitações de Compra", 'M',
				200300010, 1, true, FGestaoSol.class);
		addOpcao(200000000, TP_OPCAO_ITEM, "Cotação Sumarizada de Preços", "Cotação Sumarizada de Preços", 'Z',
				200300020, 1, true, FCotacaoItens.class);
		addSeparador(200000000);
		addOpcao(200000000, TP_OPCAO_ITEM, "Cotação de Preços", "Cotação de Preços", 'T', 200400000, 1, true,
				FCotacaoPrecos.class);
		addSeparador(200000000);
		addOpcao(200000000, TP_OPCAO_ITEM, "Compra", "Compra", 'C', 200600000, 1, true, FCompra.class);
		addOpcao(200000000, TP_OPCAO_ITEM, "Conhecimento de Frete", "Conhecimento de Frete", 'F', 200800000, 1, true,
				FConhecFrete.class);
		...
		addOpcao(200700000, TP_OPCAO_ITEM, "Compras por fornecedor", "Compras por Fornecedor", 'F', 200701000, 2, true,
				FRComprasFor.class);
		addOpcao(200700000, TP_OPCAO_ITEM, "Compras geral", "Compras geral", 'p', 200702000, 2, true, FRCompras.class);
		addOpcao(200700000, TP_OPCAO_ITEM, "Compras por tipo de movimento ", "Compras por tipo de movimento", 'p',
				200703000, 2, true, FRCpTipoMov.class);
		addOpcao(200700000, TP_OPCAO_ITEM, "Compras por ítem ", "Compras por ítem", 'p', 200704000, 2, true,
				FRCpItem.class);
		addOpcao(200700000, TP_OPCAO_ITEM, "Compras por município", "Compras por município", 'm', 200705000, 2, true,
				FRCpMunicipio.class);
		addSeparador(200700000);
		addOpcao(200700000, TP_OPCAO_ITEM, "Fretes de Rec.Merc.", "Fretes de Rec.Merc.", 'c', 200705000, 2, true,
				FRFreteRecMerc.class);
		addOpcao(200700000, TP_OPCAO_ITEM, "Fretes de Expedição", "Fretes de Expedição", 'x', 200706000, 2, true,
				FRFreteExpedicao.class);
		addSeparador(200700000);
		addOpcao(200700000, TP_OPCAO_ITEM, "Mat.prima por Fornecedor", "Mat.prima por Fornecedor", 'f', 200707000, 2,
				true, FRMatPrimaFor.class);
		addOpcao(200000000, TP_OPCAO_ITEM, "Atualiza Fornecedor/Produto", "Atualiza Fornecedor/Produto", 'A', 200800000,
				1, true, FAtualizaForneced.class);
		addSeparador(200700000);
		addOpcao(200700000, TP_OPCAO_ITEM, "Ordens de compra pendentes", "Ordens de compra pendentes", 's', 200708000,
		...
		addOpcao(300000000, TP_OPCAO_ITEM, "Devolução de vendas", "Devolução de vendas", 'D', 300300000, 1, true,
				FDevolucao.class);
		...
		addOpcao(300000000, TP_OPCAO_ITEM, "Lançamento canhotos de entrega", "Lançamento de canhotos de entrega", 'h',
				301500000, 1, true, FEntrega.class);
		...
		addSeparador(300000000);
		addOpcao(300000000, TP_OPCAO_ITEM, "Requisição de material", "Requisição de material", 'm', 300900000, 1, true,
				FRma.class);
		addOpcao(300000000, TP_OPCAO_ITEM, "Pesquisa requisição de material", "Pesquisa requisição de material", 'm',
				301300000, 1, true, FConsRMA.class);
		addOpcao(300000000, TP_OPCAO_ITEM, "Pesquisa item de Rma", "Pesquisa item de requisição de material", 'i',
				301400000, 1, true, FConsRmaItem.class);
		addSeparador(300000000);
		addOpcao(300000000, TP_OPCAO_MENU, "Listagens", "", 's', 301000000, 1, false, null);
		addOpcao(301000000, TP_OPCAO_ITEM, "Resumo diário", "Resumo Diário", 'R', 301001000, 2, true,
				FRResumoDiario.class);
		addOpcao(301000000, TP_OPCAO_ITEM, "Vendas geral", "Vendas em Geral", 'V', 301002000, 2, true,
				FRVendasGeral.class);
		addOpcao(301000000, TP_OPCAO_ITEM, "Vendas físico", "Físico de Vendas", 'd', 301003000, 2, true,
				FRVendasFisico.class);
		addOpcao(301000000, TP_OPCAO_ITEM, "Vendas detalhado", "Vendas Detalhadas", 'n', 301004000, 2, true,
				FRVendasDet.class);
		addOpcao(301000000, TP_OPCAO_ITEM, "Vendas por ítem", "Vendas por Item", 'e', 301005000, 2, true,
				FRVendasItem.class);
		addOpcao(301000000, TP_OPCAO_ITEM, "Média de vendas por ítem", "Media de vendas por item", 'o', 301006000, 2,
				true, FRMediaItem.class);
		addOpcao(301000000, TP_OPCAO_ITEM, "Ultimas Vendas por Cliente", "", 'C', 301007000, 2, true,
				FRUltimaVenda.class);
		addOpcao(301000000, TP_OPCAO_ITEM, "Vendas por Setor", "Vendas por Setor", 't', 301008000, 2, true,
				FRVendaSetor.class);
		addOpcao(300000000, TP_OPCAO_MENU, "Gráficos", "", 'G', 301100000, 1, false, null);
		addOpcao(301100000, TP_OPCAO_ITEM, "Evolução de vendas", "Evolução de vendas", 'E', 301101000, 2, true,
				FREvoluVendas.class);
		addSeparador(300000000);
		...
		addOpcao(400000000, TP_OPCAO_ITEM, "Mov. Numero de Série", "Mov. Numero de Série", 'M', 400200000, 1, true,
				FMovSerie.class);
		...
		addOpcao(400000000, TP_OPCAO_ITEM, "Consulta preço", "Consulta preço", 'P', 400500000, 1, true,
				FConsPreco.class);
		addOpcao(400000000, TP_OPCAO_ITEM, "Tipos de movimentos", "Tipo de Movimento", 'T', 400600000, 1, true,
				FTipoMov.class);
		addSeparador(400000000);
		addOpcao(400000000, TP_OPCAO_ITEM, "Reprocessa estoque", "Reprocessa estoque", 'R', 400700000, 1, true,
				FProcessaEQ.class);
		addSeparador(400000000);
		addOpcao(400000000, TP_OPCAO_MENU, "Listagens", "", 'L', 400800000, 1, false, null);
		addOpcao(400800000, TP_OPCAO_ITEM, "Estoque mínimo", "Estoque Mínimo", 's', 400801000, 2, true,
				FREstoqueMin.class);
		addOpcao(400800000, TP_OPCAO_ITEM, "Produtos/Movimentos", "Listagem de Produtos", 'P', 400802000, 2, true,
				FRMovProd.class);
		addOpcao(400800000, TP_OPCAO_ITEM, "Vencimentos de lote", "Vencimento Lote", 'V', 400803000, 2, true,
				FRVencLote.class);
		addOpcao(400800000, TP_OPCAO_ITEM, "Saldos de lote", "Saldos de Lote", 'l', 400804000, 2, true,
				FRSaldoLote.class);
		addOpcao(400800000, TP_OPCAO_ITEM, "Demanda", "Demanda", 'D', 400805000, 2, true, FRDemanda.class);
		addOpcao(400800000, TP_OPCAO_ITEM, "Conferência", "Conferência de Estoque", 'C', 400806000, 2, true,
				FRConfEstoq.class);
		addOpcao(400800000, TP_OPCAO_ITEM, "Inventário", "Inventário", 'I', 400807000, 2, true, FRInvPeps.class);

		addOpcao(400800000, TP_OPCAO_ITEM, "Codifição de produto", "Codificação de produto", 'P', 400800800, 2, true,
				FRCodficProd.class);
		addOpcao(400800000, TP_OPCAO_ITEM, "Etiquetas de código de barras", "Etiquetas de código de barras", 'E',
				400800900, 2, true, FRCodbarProd.class);
		addOpcao(400800000, TP_OPCAO_ITEM, "Ultimas compras/produto", "Ultimas compras/produto", 'E', 400801000, 2,
				true, FRCpProd.class);
		addOpcao(400800000, TP_OPCAO_ITEM, "Movimentação de Produto Controlado", "Movimentação de Produto Controlado",
				'M', 400802000, 2, true, FRMovProdCont.class);
		addOpcao(400800000, TP_OPCAO_ITEM, "Estoque liquido", "Estoque liquido", 'L', 400803000, 2, true,
				FREstoqueLiquido.class);
		addOpcao(400800000, TP_OPCAO_ITEM, "Produtos por grupo", "Produtos pro grupo", 'G', 400804000, 2, true,
				FRProdGrup.class);
		addOpcao(400800000, TP_OPCAO_ITEM, "Giro de estoque", "Giro de estoque", 'i', 400805000, 2, true,
				FRGiroEstoque.class);
		addOpcao(400800000, TP_OPCAO_ITEM, "Contagem de estoque", "Contagem de estoque", 's', 700706000, 2, true,
				FRContaEstoque.class);
		addOpcao(400800000, TP_OPCAO_ITEM, "Valor em estoque", "Valor em estoque", 'v', 400807000, 2, true,
				FRValorEstoque.class);

		addOpcao(-1, TP_OPCAO_MENU, "Recepção", "", 'R', 500000000, 0, false, null);
		addOpcao(500000000, TP_OPCAO_ITEM, "Painel de controle", "Painel de Controle", 'P', 500100000, 1, true,
				FControleRecMerc.class);
		addSeparador(500000000);
		addOpcao(500000000, TP_OPCAO_ITEM, "Recepção de matéria prima", "Recepção de matéria prima", 'R', 500200000, 1,
				true, FRecMerc.class);
		addOpcao(500000000, TP_OPCAO_ITEM, "Coleta de materiais", "Coleta de materiais", 'C', 500400000, 1, true,
				FColeta.class);
		addSeparador(500000000);
		addOpcao(500000000, TP_OPCAO_ITEM, "Tipos de Recepção", "Cadastro de tipos de recepção de mercadorias", 'T',
				500300000, 1, true, FTipoRecMerc.class);
		addSeparador(500000000);
		addOpcao(500000000, TP_OPCAO_MENU, "Listagens", "", 'L', 500500000, 1, false, null);
		addOpcao(500500000, TP_OPCAO_ITEM, "Coletas por dia", "Coletas por dia", 'o', 500501000, 2, true,
				FRColetas.class);
		addOpcao(500500000, TP_OPCAO_ITEM, "Entradas/peso", "Relação de entradas/peso", 'e', 500501100, 2, true,
				FRPesoRecMerc.class);
		addOpcao(500500000, TP_OPCAO_ITEM, "Preço médio/diário", "Preço médio/diário", 'P', 500501200, 2, true,
				FRPrecoMedioRecMerc.class);

		addOpcao(-1, TP_OPCAO_MENU, "Expedição", "", 'x', 600000000, 0, false, null);

		addOpcao(600000000, TP_OPCAO_ITEM, "Painel de controle", "Painel de Controle", 'P', 600100000, 1, true,
				FControleExpedicao.class);
		addSeparador(600000000);
		addOpcao(600000000, TP_OPCAO_ITEM, "Expedição de produto acabado", "Expedição de produto acabado", 'R',
				600200000, 1, true, FExpedicao.class);
		addOpcao(600000000, TP_OPCAO_ITEM, "Tipos de Expedição", "Cadastro de tipos de expedição de produtos", 'T',
				600300000, 1, true, FTipoExpedicao.class);
		addSeparador(600000000);

		addOpcao(600000000, TP_OPCAO_ITEM, "Pesquisa requisição de material", "Pesquisa requisição de material", 'm',
				600100000, 1, true, FConsRMA.class);
		addOpcao(600000000, TP_OPCAO_ITEM, "Pesquisa item de Rma", "Pesquisa item de requisição de material", 'i',
				600200000, 1, true, FConsRmaItem.class);
		addOpcao(600000000, TP_OPCAO_ITEM, "Baixa RMA via Cód.Barras", "Baixa RMA", 'B', 600300000, 1, true,
		...
		addOpcao(700000000, TP_OPCAO_ITEM, "Painel de controle", "Painel de controle de Serviços", 'e', 700100000, 1,
				true, FControleServicos.class);
		addOpcao(700000000, TP_OPCAO_ITEM, "Ordem de Serviço", "Ordem de Serviço", 'e', 700200000, 1, true,
				FOrdemServico.class);
		addSeparador(700000000);
		addOpcao(700000000, TP_OPCAO_ITEM, "Tipo de atendente", "Tipo de atendente", 'T', 700300000, 1, true,
				FTipoAtend.class);
		addOpcao(700000000, TP_OPCAO_ITEM, "Atendente", "Atendente", 'd', 700400000, 1, true, FAtendente.class);

		addSeparador(700000000);
		addOpcao(700000000, TP_OPCAO_ITEM, "Gestão de relacionamento com clientes",
				"Gestão de relacionamento com clientes", 'A', 700500000, 1, true, FCRM.class);
		addSeparador(700000000);
		...
		addOpcao(800000000, TP_OPCAO_ITEM, "Ordens de produção", "Ordens de produção", 'O', 800100000, 1, true,
				FOP.class);
		addOpcao(800000000, TP_OPCAO_ITEM, "Simulação de OP", "Simulação de OP", 'S', 800200000, 1, true,
				FSimulaOP.class);
		addOpcao(800000000, TP_OPCAO_ITEM, "Acompanhamento da produção", "Acompanhamento da produção", 'o', 800300000,
				1, true, FAcompanhaProd.class);
		addOpcao(800000000, TP_OPCAO_ITEM, "Planejamento mestre da produção (Pull)",
				"Planejamento mestre da produção (Pull)", 'P', 800400000, 1, true, FPMP_Pull.class);
		addOpcao(800000000, TP_OPCAO_ITEM, "Planejamento mestre da produção (Push)",
				"Planejamento mestre da produção (Push)", 'P', 800500000, 1, true, FPMP_Push.class);
		addSeparador(800000000);
		addOpcao(800000000, TP_OPCAO_ITEM, "Contra Prova", "Contra prova", 'P', 800400000, 1, true, FContraProva.class);
		addSeparador(800000000);
		addOpcao(800000000, TP_OPCAO_ITEM, "Requisição de material", "Requisição de material", 'R', 800500000, 1, true,
				FRma.class);
		addOpcao(800000000, TP_OPCAO_ITEM, "Pesquisa requisição de material", "Pesquisa requisição de material", 'P',
				800600000, 1, true, FConsRMA.class);
		addOpcao(800000000, TP_OPCAO_ITEM, "Pesquisa RMA por item", "Pesquisa RMA por item", 'i', 800700000, 1, true,
				FConsRmaItem.class);
		addOpcao(800000000, TP_OPCAO_ITEM, "Baixa RMA via Cód.Barras", "Baixa RMA", 'B', 800800000, 1, true,
				FBaixaRMACodBar.class);
		// addOpcao( 800000000, TP_OPCAO_ITEM, "Teste Java", "Teste Java", 'T',
		// 800800200, 1, true, FTesteJava.class );

		addSeparador(800000000);
		addOpcao(800000000, TP_OPCAO_MENU, "Listagens", "", 'L', 800900000, 1, false, null);
		addOpcao(800900000, TP_OPCAO_ITEM, "Certificação de análise", "Certificação de análise", 'C', 800900100, 1,
				true, FRCertAnalise.class);
		addOpcao(800900000, TP_OPCAO_ITEM, "Análises", "Análises", 'C', 800900200, 1, true, FRAnalise.class);
		addOpcao(800900000, TP_OPCAO_ITEM, "Contra-Provas", "Contra-Provas", 'C', 800900300, 1, true,
				FRContraProva.class);
		addOpcao(800900000, TP_OPCAO_ITEM, "Produção", "Produção", 'P', 800900400, 1, true, FRProducao.class);
		addOpcao(800900000, TP_OPCAO_ITEM, "Estruturas por item", "Estruturas por item", 'z', 800900500, 1, true,
				FREstruturaItem.class);
		addOpcao(800900000, TP_OPCAO_ITEM, "Comissionamento/produtividade", "Comissionamento/produtividade", 'C',
				800900600, 1, true, FRComisProd.class);
		...
		addBotao("btsoliccp.png", "Solicitação de Compra", "Solicitação de Compra", 200100000,
				FSolicitacaoCompra.class);
		...
		addBotao("btPainelServico.png", "Painel de Controle de Serviços", "Painel de Controle de Serviços", 700100000,
