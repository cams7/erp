...
public class FreedomATD extends AplicativoPD implements ActionListener {
	...
	public FreedomATD() {
		...
		super("iconatd.png", "splashATD.png", 1, "Freedom", 4, "Atendimento", null,
		...
		addOpcao(100101000, TP_OPCAO_ITEM, "Tipo de Conveniado", "Tipo de conveniados", 'T', 100101010, 3, true,
				FTipoConv.class);
		addOpcao(100101000, TP_OPCAO_ITEM, "Atribuições", "Abribuições", 'A', 100101020, 3, true, FAtribuicao.class);
		addOpcao(100101000, TP_OPCAO_ITEM, "Encaminhador", "Encaminhador", 'E', 100101030, 3, true,
				FEncaminhador.class);
		...
		addOpcao(100102000, TP_OPCAO_ITEM, "Tipo de Atendente", "Tipo de atendentes", 'T', 100102010, 3, true,
				FTipoAtend.class);
		...
		addOpcao(100103000, TP_OPCAO_ITEM, "Setor de Atendimento", "Setor de Atendimento", 'S', 100103010, 3, true,
				FSetorAtend.class);
		addSeparador(100103000);
		addOpcao(100103000, TP_OPCAO_ITEM, "Atendente", "Atendente", 'e', 100103020, 1, true, FAtendente.class);
		addOpcao(100103000, TP_OPCAO_ITEM, "Tipo de Atendente", "Tipo de Atendente", 'i', 100103030, 1, true,
				FTipoAtend.class);
		...
		addOpcao(100200000, TP_OPCAO_ITEM, "Preferências Gerais", "Preferências Gerais", 'P', 100201000, 2, true,
				FPrefereAtend.class);
		...
		addOpcao(100401000, TP_OPCAO_ITEM, "Situação de Orçamentos", "Ajuste de Situação de Orçamentos", 'P', 100401010,
				2, true, FAjustaSitOrc.class);
		...
		addOpcao(110000000, TP_OPCAO_ITEM, "Tipos de Atendimento", "Tipo de atendimento", 'T', 110200000, 1, true,
				FTipoAtendo.class);
		...
		addOpcao(1200000000, TP_OPCAO_ITEM, "Pesquisa Orçamentos", "Pesquisa Orcamentos", 'P', 120200000, 1, true,
				FConsOrc.class);
		addOpcao(1200000000, TP_OPCAO_ITEM, "Aprova Orçamentos", "Aprova Orcamento", 'A', 120300000, 1, true,
				FAprovaOrc.class);
		addOpcao(1200000000, TP_OPCAO_ITEM, "Pesquisa Autorizações", "Pesquisa Autorização", 'e', 120400000, 1, true,
				FConsAutoriz.class);
		addOpcao(1200000000, TP_OPCAO_ITEM, "Termo de Recebimento", "Termo de Recebimento", 'e', 120500000, 1, true,
				FRTermReceb.class);
