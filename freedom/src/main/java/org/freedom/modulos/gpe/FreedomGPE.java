...
public class FreedomGPE extends AplicativoPD {
	...
	public FreedomGPE() {
		...
		super("icongrh.png", "splashGRH.png", 1, "Freedom", 10, "Gestão de Ponto Eletrônico", null,
		...
		addOpcao(100100000, TP_OPCAO_ITEM, "Empregadores", "Empregadores", 'p', 100100500, 2, true,
				FEmpregadores.class);
		addOpcao(100100000, TP_OPCAO_ITEM, "Benefícios", "Cadastro de Benefícios", 'b', 100100600, 2, true,
				FBeneficio.class);

		addSeparador(100100000);
		addOpcao(100100000, TP_OPCAO_ITEM, "Estados civis", "Estados civis", 's', 100100700, 2, true,
				FEstadoCivil.class);
		addSeparador(100100000);
		addOpcao(100100000, TP_OPCAO_ITEM, "Feriados", "Cadastro de Feriados", 'r', 100100800, 2, true,
				FFeriados.class);

		addOpcao(-1, TP_OPCAO_MENU, "Ponto", "", 'P', 200000000, 0, false, null);
		addOpcao(200000000, TP_OPCAO_ITEM, "Digitação de Livro Ponto", "Digitação de Livro Ponto", 'D', 200100000, 1,
				true, FBatida.class);

		addOpcao(200000000, TP_OPCAO_ITEM, "Exclusão de Livro Ponto", "Exclusão de Livro Ponto", 'D', 200200000, 1,
				true, FExcluLivroPonto.class);

		addOpcao(200000000, TP_OPCAO_ITEM, "Cadastro de Faltas", "Cadastro de Faltas", 'F', 200300000, 1, true,
				FFalta.class);

		addSeparador(20000000);
		addOpcao(200000000, TP_OPCAO_MENU, "Listagens", "", 'L', 200400000, 1, false, null);
		addOpcao(200400000, TP_OPCAO_ITEM, "Relatório de Batidas/Ponto", "Relatório de Batidas/Ponto", 'B', 200401000,
				2, true, FRBatidas.class);
