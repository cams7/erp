...
public class FreedomLVF extends AplicativoPD {
	...
	public FreedomLVF() {
		...
		super("iconlvf.png", "splashLVF.png", 1, "Freedom", 10, "Livros Fiscais", null,
		...
		addOpcao(100101000, TP_OPCAO_ITEM, "Classificação de cliente", "Classifição de Clientes", 'f', 100101040, 3,
				true, FClasCli.class);
		...
		addOpcao(200000000, TP_OPCAO_ITEM, "Regras fiscais", "Regras Fiscais", 'R', 200200000, 1, true,
				FRegraFiscal.class);
		addOpcao(200000000, TP_OPCAO_ITEM, "Sintegra", "Gera Arquivo Sintegra", 'S', 200300000, 1, true,
				FSintegra.class);
		addOpcao(200000000, TP_OPCAO_ITEM, "Tabela de Alíquotas", "Tabela de alíquotas", 'T', 200400000, 1, true,
				FTabICMS.class);
		...
		addOpcao(200600000, TP_OPCAO_ITEM, "ICMS por NCM/CFOP", "ICMS por NCM/CFOP", 'N', 200604000, 2, true,
				FRIcmsNcm.class);
		addOpcao(200600000, TP_OPCAO_ITEM, "IPI", "IPI", 'P', 200606000, 2, true, FRIpi.class);
		addOpcao(200600000, TP_OPCAO_ITEM, "Impostos sobre serviços", "Impostos sobre serviços", 'S', 200602000, 2,
				true, FRImpServ.class);
		addOpcao(800600000, TP_OPCAO_ITEM, "PIS/COFINS", "Mov. PIS/COFINS", 'P', 200605000, 2, true, FRPisCofins.class);
		addOpcao(200600000, TP_OPCAO_ITEM, "Movimentação com PIS e COFINS", "Movimentação com PIS e COFINS", 'P',
				200603000, 2, true, FRMovPisCofins.class);

		addOpcao(200600000, TP_OPCAO_ITEM, "Modelo de NFs", "Modelo de NFs", 'M', 200607000, 2, true, FModNota.class);
		addOpcao(200600000, TP_OPCAO_ITEM, "Modelo de Doc. Fiscais", "Modelo de Doc. Fiscais", 'i', 200608000, 2, true,
				FModDocFisc.class);

		addOpcao(-1, TP_OPCAO_MENU, "Entrada", "", 'E', 300000000, 0, false, null);
		addOpcao(300000000, TP_OPCAO_ITEM, "Registro de Entrada", "Registro de Entrada", 'E', 300100000, 1, true,
				FRRegitroEntrada.class);

		addOpcao(-1, TP_OPCAO_MENU, "Saida", "", 'S', 400000000, 0, false, null);
		addOpcao(400000000, TP_OPCAO_ITEM, "Registro de Saida", "Registro de Saida", 'S', 400100000, 1, true,
				FRRegitroSaida.class);
		addOpcao(400000000, TP_OPCAO_ITEM, "Registro de Duplicatas", "Registro de Duplicatas", 'S', 400200000, 1, true,
				FRRegDuplicatas.class);

		addOpcao(-1, TP_OPCAO_MENU, "Estoque", "", 't', 500000000, 0, false, null);
		addOpcao(500000000, TP_OPCAO_ITEM, "Registro de Inventário", "Registro de Inventário", 'E', 500100000, 1, true,
				FRRegitroInventario.class);
