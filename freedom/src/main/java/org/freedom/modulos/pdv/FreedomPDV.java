...
public class FreedomPDV extends AplicativoPDV {
	...
	public FreedomPDV() {
		...
		addOpcao(100101000, TP_OPCAO_ITEM, "Tipo fiscal de cliente...", "Tipo Fiscal de Cliente", 'p', 100101040, 3,
				true, FTipoFisc.class);
		...
		addOpcao(100105000, TP_OPCAO_ITEM, "Manutenção de Preços", "Manutenção de Preços", 'M', 100105010, 3, true,
				FManutPreco.class);
		addOpcao(100105000, TP_OPCAO_ITEM, "Copia preço", "Copia Precos", 'i', 100105020, 3, true, FCpProd.class);
		addOpcao(100105000, TP_OPCAO_ITEM, "Tabela de preço", "Tabelas de Preços", 'a', 100105030, 3, true,
				FTabPreco.class);
		addOpcao(100105000, TP_OPCAO_ITEM, "Lista de preço", "Lista de Preços", 'l', 100105040, 3, true,
				FRListaPreco.class);

		addOpcao(100000000, TP_OPCAO_MENU, "Preferências", "", 'P', 100200000, 1, false, null);
		addOpcao(100200000, TP_OPCAO_ITEM, "Preferências gerais", "Prefere Geral", 'g', 100201000, 2, true,
				FPreferePDV.class);
		addOpcao(100200000, TP_OPCAO_ITEM, "Funções Administrativas TEF", "Admin TEF", 'A', 100202000, 2, true,
				FAdmTef.class);
		...
		addOpcao(200000000, TP_OPCAO_ITEM, "Cancela venda", "Cancela Venda", 'C', 200200000, 2, true,
				DLCancCupom.class);
		addSeparador(200000000);
		addOpcao(200000000, TP_OPCAO_ITEM, "Suprimento", "Suprimento de caixa", 'u', 200300000, 2, true,
				FSuprimento.class);
		...
		addOpcao(200000000, TP_OPCAO_ITEM, "Leitura X", "Impressão de leitura X", 'X', 110800000, 2, true,
				FLeituraX.class);
		addSeparador(200000000);
		addOpcao(200000000, TP_OPCAO_ITEM, "Fechamento de Caixa", "Efetua um fechamento de caixa", 'F', 110800001, 2,
				true, DLFechaDia.class);
